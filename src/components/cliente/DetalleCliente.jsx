    ...
    return (
        ...
        >
            ...
            <View style={styles.topButtons}>
                ...
                <TouchableOpacity style={styles.buttonPrimary} onPress={() => navigation.navigate("Cliente")}>
                    <ArrowBigLeft color="#FFF" />
                    <Text style={styles.buttonText}>Regresar</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.buttonSecondary} onPress={() => navigation.navigate("EditarCliente", {
                    item: datosCompletos
                })} >
                    <Pencil color="#FFF" />
            ...
            <TouchableOpacity onPress={() => navigation.navigate("UbicacionCliente", {
