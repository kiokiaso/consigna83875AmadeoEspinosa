...
const CrearCliente = ({ navigation, route }) => {
    const [form, setForm] = useState({ monto: route.params.item.monto, modelo: route.params.item.modelo, observaciones: route.params.item.observaciones });
    ...
    const crearOportunidad = () => {
        Object.entries(form).forEach(([key, value]) => {
            ...
            navigation.navigate("DetalleOportunidad", { item: route.params.item.id })
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                >
                    ...
                    <View style={{ marginBottom: 20 }}>
                        <Text style={styles.nombreCampo}>Selecciona el tipo de venta</Text>
                        <View >
                            <ModalSelector
                                data={datosTipo}
                                initValue={tipo}
                    ...
                    <TouchableOpacity onPress={() => {
                        navigation.navigate("DetalleOportunidad", {
