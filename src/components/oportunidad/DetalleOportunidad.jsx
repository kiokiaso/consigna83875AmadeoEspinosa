...
const DetalleOportunidad = ({ route, navigation }) => {
    ...
    const {
        ...
        email,
        ubicacion,
    } = useSelector(state => state.prospectoReducer.lista.find(p => p.id === route.params.item));
    const datosCompletos = useSelector(state => state.prospectoReducer.lista.find(p => p.id === route.params.item));
    ...
    /*
    console.log("--------------------------------------------")
    console.log("Datos de la oportunidad desde detalle: ",route.params.item)
    console.log("--------------------------------------------")
    ...
    return (
        ...
        >
            ...
            <View style={styles.topButtons}>
                ...
                <TouchableOpacity style={styles.buttonPrimary} onPress={() => navigation.navigate("Oportunidad")}>
                    <ArrowBigLeft color="#FFF" />
                    <Text style={styles.buttonText}>Regresar</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.buttonSecondary} onPress={() => navigation.navigate("EditarOportunidad", {
                    item: datosCompletos
                })} >
                    <Pencil color="#FFF" />
            ...
            <View style={styles.card}>
                ...
                <InfoItem label="Tipo" value={datosCompletos.tipo} />
                <InfoItem label="Estado del equipo" value={datosCompletos.estadoOportunidad} />
                <InfoItem label="Tipo de MFP" value={datosCompletos.tipoMFP} />
                <InfoItem label="Tamaño del papel" value={datosCompletos.tamano} />
                <InfoItem label="Marca" value={datosCompletos.marca} />
                <InfoItem label="Modelo" value={datosCompletos.modelo} />
                <InfoItem label="Monto" value={datosCompletos.monto} />
            </View>
            {/* Botón para crear oportunidad */}
            <TouchableOpacity onPress={() => navigation.navigate("CrearCliente", {
                item: datosCompletos
            })} style={styles.btnOporunidad}>
                <MaterialIcons name="point-of-sale" size={24} color="white" />
                <Text style={styles.btnText}>Crear Venta</Text>
            </TouchableOpacity>

            {/* Botón para ubicación */}
            <TouchableOpacity onPress={() => navigation.navigate("UbicacionOportunidad", {
