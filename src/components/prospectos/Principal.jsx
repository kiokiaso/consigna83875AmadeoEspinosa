...
export default function Principal({ cambiarPrincipal, localId,data,navigation}) {
   //console.log("props")
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.topButtons}>
                ...
                <TouchableOpacity style={styles.buttonPrimary} onPress={cambiarPrincipal}>
            ...
            <View style={styles.table}>
                ...
                datos?.map((item) => (
                    <View key={item.id} style={styles.tableRow}>
                        ...
                        <TouchableOpacity style={styles.detailButton} onPress={() => navigation.navigate('DetalleProspecto',{
                            item, localId
                        })}> 
                ...
                {/*
                    datos?
                        (<View><Text>Hay</Text></View>)
                    :(<View key={item.id} style={styles.tableRow}>
                                <Text style={styles.rowText}>No hay datos</Text>
                            </View>)*/
                }
            </View>
